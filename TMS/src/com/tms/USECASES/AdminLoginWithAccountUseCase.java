...
//			Boolean adminIsPresent = admin.adminLogin(adminUserName, adminPassword);
			...
			if (adminIsPresent) {
				...
				while (true) {
					...
					System.out.println("==========================================================");
					System.out.println();
					System.out.println("Enter 1  register new vendor");
					System.out.println("Enter 2  view all vendors");
					System.out.println("Enter 3  Create new tenders.");
					System.out.println("Enter 4  view all tendors");
					System.out.println("Enter 5  View All the Bids of a tender.");
					System.out.println("Enter 6  Assign tender to a vendor");
